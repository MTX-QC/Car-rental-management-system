...
public class UserServiceImpl  implements UserService {
    ...
    //升级为vip
    @Override
    public void updateToVip(Integer id) {
        userMapper.updateToVip(id); ;
    }
...
//      设置当天为用户的离职时间
     ...
     */
    @Override
    public PageResult queryAuditUser(User user, Integer pageNum, Integer pageSize) {
        // 使用分页插件:
        PageHelper.startPage(pageNum, pageSize);
        Page<User> page =  userMapper.queryAuditUser(user);
        return new PageResult(page.getTotal(),page.getResult());
    }
