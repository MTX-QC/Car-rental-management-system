...
<div class="box-body">
    ...
    <table id="dataList" class="table table-bordered table-striped table-hover dataTable text-center">
        <thead>
        <tr>
            <th class="sorting_asc">新车名称</th>
            <th class="sorting">型号</th>
            <th class="sorting">出厂商</th>
            <th class="sorting">标准ISBN</th>
            <th class="sorting">汽车状态</th>
            <th class="sorting">租用人</th>
            <th class="sorting">租用时间</th>
                ...
                <td class="text-center">
                    <c:if test="${book.status ==0}">
                        <button type="button" class="btn bg-olive btn-xs" data-toggle="modal" data-target="#borrowModal"
                                onclick="findBookById(${book.id},'borrow')"> 租借
                        </button>
                    </c:if>
