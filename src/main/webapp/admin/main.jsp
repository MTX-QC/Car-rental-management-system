            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/user/queryAuditUser" target="iframe">
                ...
                <!-- 发布信息管理 -->
                <li id="admin-login1">
                    <a href="${pageContext.request.contextPath}/message/ReleaseInformationManagement" target="iframe">
                        <i class="fa fa-circle-o"></i>发布车辆管理
                    </a>
                </li>
                <!-- 车辆管理 -->
                <li class="treeview">
