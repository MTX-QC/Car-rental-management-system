...
<div class="loginmanage">
  <div class="py-container">
    <h4 class="manage-title">欢迎来到注册页面</h4>
    <div class="loginform">
        ...
        <div id="profile" class="tab-pane  active">
          <form id="registerform" class="sui-form" action="${pageContext.request.contextPath}/user/register"
            ...
            <div class="input-prepend"><span class="add-on loginname">用户名</span>
              <input type="text" placeholder="昵称" class="span2 input-xfat" name="name">
            </div>
            ...
            <div class="logined">
              <a class="sui-btn btn-block btn-xlarge btn-danger"
                 href='javascript:document:registerform.submit();' target="_self">注&nbsp;&nbsp;册</a>
            </div>
          </form>
        </div>
      </div>
